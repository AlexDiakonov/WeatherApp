...
let cityName;
window.addEventListener('load', loadDefaultRender);
...
function hideAndShowYarik() {
  document.querySelector('.modal').classList.add('slide-in2');
  document.querySelector('.weather-container').classList.add('slide-out1');
}
function hideAndShowSasha() {
  document.querySelector('.modal').classList.remove('slide-in2');
  document.querySelector('.weather-container').classList.remove('slide-out1');
}
